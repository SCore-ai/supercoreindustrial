...
import type { PartnerSeries } from "@lib/partner-brands/types"

export type PartnerSeriesTile = {
  series: PartnerSeries
  count: number
  image: string | null
}

const PartnerSeriesGrid = ({
  heading,
  tiles,
}: {
  heading: string
  tiles: PartnerSeriesTile[]
}) => {
  return (
...
export default PartnerSeriesGrid
